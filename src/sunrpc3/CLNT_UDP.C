 ...
 */
static enum clnt_stat	clntudp_call(REGISTER2 CLIENT *cl,u_long proc, xdrproc_t xargs, caddr_t argsp, xdrproc_t xresults, caddr_t resultsp, struct timeval	utimeout);
static void				clntudp_abort(CLIENT *cl);
	...
	u_int recvsz;
{
	...
	if (cl == NULL) {
#ifdef _WIN32
		sun_rpc_report("clntudp_create: out of memory\n");
...
clntudp_call(cl, proc, xargs, argsp, xresults, resultsp, utimeout)
	REGISTER2 CLIENT	*cl;		/* client handle */
