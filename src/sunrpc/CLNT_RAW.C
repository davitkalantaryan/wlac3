...
static void		clntraw_abort(CLIENT *h);
...
static void		clntraw_destroy(CLIENT *h);
...
static void
clntraw_geterr(CLIENT * h, struct rpc_err *e)
{
}
...
static void
clntraw_abort(CLIENT *h)
{
}

static bool_t
clntraw_control(CLIENT*h, int c, char* b)
{
	return (FALSE);
}

static void
clntraw_destroy(CLIENT *h)
{
}
