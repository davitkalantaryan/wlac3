...
#if !defined(xdrproc_t_defined) && !defined(xdrproc_t)
...
typedef struct CLIENTstruct {
	...
	struct clnt_ops {
		enum clnt_stat	(*cl_call)(REGISTER2 struct CLIENTstruct *, u_long, xdrproc_t, caddr_t, xdrproc_t, caddr_t, struct timeval);	/* call remote procedure */
		...
		bool_t          (*cl_control)(struct CLIENTstruct*, int, char*);/* the ioctl() of rpc */
	} *cl_ops;
 ...
 */
extern CLIENT *
clnt_create(char* host, unsigned prog, unsigned vers, char* prot);
/*
	char *host; 	-- hostname
 ...
 */
char *clnt_sperrno(enum clnt_stat stat);	/* string */
